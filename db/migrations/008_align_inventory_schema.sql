-- Align inventory tables with the fields used by the application

-- Ensure areas support a type value
...
-- Ensure containers support type and color values
...
-- Align inventory items with the application schema
